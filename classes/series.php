...
class evangelical_magazine_series extends evangelical_magazine_not_articles {
    ...
    */
    public function _get_articles ($args) {
        $meta_query = array(array('key' => evangelical_magazine_article::self, 'value' => $this->get_id(), 'compare' => '='));
        $default_args = array ('post_type' => 'em_article', 'meta_query' => $meta_query, 'meta_key' => evangelical_magazine_article::self, 'orderby' => 'meta_value_num', 'order' => 'ASC');
